...
int main() {
    ...
    // Answer: Yes it did use dynamic dispatch because we used virtual
    // How did you test this? We print it

    Creature *og = new Creature(10);
    Creature *amoeba = new Amoeba(20);
    std::cout << "Creatures before cloning: " << *og << *amoeba << std::endl;
    Creature *og2 = og->Clone();
    Creature *amoeba2 = amoeba->Clone();
    std::cout << "Creatures after cloning: " << *og << *amoeba << std::endl;
    std::cout << "Cloned creatures: " << *og2 << *amoeba2 << std::endl;
